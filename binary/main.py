...
def bound_run(parse_para, epochs, ds_list, strategy:str, method_list, new_img_num_list, bound, acquire_instruction: Config.Acquistion):
...
def main(epochs, new_model_setter='retrain', pure=False, model_dir ='', strategy='', device=0, base_type='', detector_name=''):
    ...
    for bound in bounds:
        ...
        bound_run(parse_para, epochs, ds_list, strategy, method_list, new_img_num_list, bound, acquire_instruction)
...
if __name__ == '__main__':
    ...
    main(args.epochs,pure=args.pure,model_dir=args.model_dir,strategy=args.strategy,device=args.device, base_type=args.base_type, detector_name=args.detector_name)
    # print(args.method)