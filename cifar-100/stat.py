...
def get_clf_statistics(new_img_num_list, new_model_config:Config.NewModel, acquire_instruction:Config.Acquistion):
    shift_score_list = []
    clf_precision_list = []
...
def main(epochs, new_model_setter='retrain', pure=False, model_dir ='', check_method='', device=0, augment=True):
    ...
    for epo in range(epochs):
        ...
        score_epo, prec_epo = get_clf_statistics(new_img_num_list, new_model_config, acquire_instruction)
