...
def run(ds:Dataset.DataSplits, model_config:Config.OldModel, train_flag:bool, detect_instruction:Config.Detection, config):
    ...
    shift_score = DataStat.mis_label_stat('test_shift', ds, base_model, check_labels)
...
def main(epochs,  model_dir ='', train_flag=False, device_id=0, base_type='', detector_name=''):
    ...
    for epo in range(epochs):
        ...
        prec, acc_shift, detect_prec, shift_score = run(ds, old_model_config, train_flag, detect_instrution, config)
